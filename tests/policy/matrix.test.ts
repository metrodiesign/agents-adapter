...
test("required matrix decisions match the specification table", () => {
  ...
  const expected: Record<string, string> = {
    ...
    GIT_REMOTE_CHANGE: "ASK", GIT_RESET_HARD: "ASK", GIT_CLEAN: "ASK", GH_PR_CREATE: "ALLOW", GH_PR_UPDATE: "ALLOW", GH_PR_MERGE: "DENY", GH_REPO_DELETE: "DENY",
    PUBLIC_GIST: "DENY", PI_SHARE: "DENY", STAGING_DEPLOY: "ASK", PROD_DEPLOY: "ASK", PROD_DB_WRITE: "ASK", PROD_DESTRUCTIVE_DB: "ASK", SAFETY_BYPASS: "DENY", OUTSIDE_TRUST_ZONE: "ASK",
  };
