...
export function codexRules(config: UserConfig): PrefixRule[] {
  const rules: PrefixRule[] = [
    ...
    { pattern: ["gh", "pr", "merge"], decision: "prompt", justification: "GH_PR_MERGE: merge is a user decision", ruleId: "GH_PR_MERGE" },
    { pattern: ["git", "tag", ["-a", "-s", "-f", "-m"]], decision: "prompt", justification: "RELEASE_TAG", ruleId: "RELEASE_TAG" },
    { pattern: ["git", "push", ["--tags", "--follow-tags"]], decision: "prompt", justification: "RELEASE_TAG", ruleId: "RELEASE_TAG" },
    ...
    { pattern: ["gh", "release", ["create", "edit", "upload", "delete"]], decision: "prompt", justification: "RELEASE_TAG", ruleId: "RELEASE_TAG" },
